...
export class XMindEmbedViewer {
    ...
    constructor(args) {
        ...
        const iframeController = new IframeController(el, `/embed-viewer${isPitchModeDisabled ? '?pitch-mode=disabled' : ''}`);
        const iframeEventChannelController = new IframeEventChannelController(iframeController);
